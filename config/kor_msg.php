...
$titSession['listTitle']= array("callCnt"=>"동시콜수","callNumber"=>"발신전화번호", "sDate"=>"시화일자","sTime"=>"시화시간","sDateTime"=>"시화일지","eDateTime"=>"종료일시","duration"=>"발언시간","reNumber"=>"상대방번화번호", "sendIP"=>"발신IP", "reIP"=>"상대방IP","callType"=>"호종류", "callStauts"=>"호상태", "avType"=>"영상/음성", "trk"=>"TRK", "inc"=>"INC", "stn"=>"STN", "callCount"=>"콜 수", "total"=>"합계", "dateFomat"=>"검색 단위", "date"=>"날짜");
